          ...
          <div className="fade-up" style={{ marginBottom: '56px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontSize: '64px', fontWeight: 800, fontFamily: 'Syne', letterSpacing: '-0.04em', lineHeight: 1, color: result.ats_score >= 85 ? 'rgba(80,220,120,0.9)' : result.ats_score >= 70 ? 'rgba(220,180,80,0.9)' : 'rgba(220,80,80,0.9)' }}>
                  {result.ats_score}
                </div>
              ...
              {result.resume?.experience?.map((exp: any, i: number) => (
                <div key={i} style={{ marginBottom: '28px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                    ...
                    <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.2)', letterSpacing: '0.03em' }}>{exp.dates}</p>
                  </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)', padding: '32px', borderRadius: '2px', marginTop: '8px' }}>
                ...
                {result.resume.ats_score_details.improvements?.map((imp: any, i: number) => (
                  <div key={i} style={{
                    ...
                    <p style={{ fontSize: '12px', color: imp.priority === 'high' ? 'rgba(255,100,100,0.7)' : 'rgba(220,180,80,0.7)', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.06em', fontSize: '10px' }}>
